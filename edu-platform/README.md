...
- **«ЕГЭ по математике: пробные варианты»** (`seed:ege`): 4 пробных варианта с
  полными пошаговыми разборами, схемами, ответами и авто-проверяемыми тестами.

Редактор урока (стиль Jupyter) поддерживает режим **«Предпросмотр»** с живым
рендером формул и схем. Веб — **PWA**: устанавливается на телефон и работает
офлайн (кэш-оболочка).
